<?php
    ...
    class Product{
        ...
        public static function getTotalPtoductByCategory($categoryId ){
            $db = Db::getConnection();
            $result = $db -> query('SELECT count(id) AS count FROM product WHERE status="1" AND category_id="'
                . $categoryId .'"');
            $result -> setFetchMode(PDO::FETCH_ASSOC);
            $row = $result -> fetch();
            return $row['count'];
        ...
        public static function createProduct($options){
            ...
            $sql = 'INSERT INTO product (name, code, price, category_id, brand, availability,'
                . 'description, is_new, is_recommended, status) VALUES '
        ...
        public static function updateProdyctById($id, $options){
            $db = Db::getConnection();
